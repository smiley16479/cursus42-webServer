...
"405 Method Not Allowed",				//A request was made of a page using a request method not supported by that page. An origin server MUST generate an Allow field in a 405 (Method Not Allowed)
